...
# Author information:
#	- Created by ZHANG Hua (zhangh20011114@gmail.com), 2024/8/12.
# =================================================================================================
...
while (${date_second_now} <= ${date_second_end})
	...
	foreach hh (${hours})
		...
		set yyyymmddhh = `date -ud @${hour_second_now} +%Y%m%d%H`
		...
		set remote_path = ${REMOTE_HOME}/${yyyy}
		set filename = SURFACE_OBS:${yyyymmddhh}
